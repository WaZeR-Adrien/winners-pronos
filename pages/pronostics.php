...
if (isset($_SESSION['connexion'])) {
    ...
    <div class="no-access">
        ...
        <div class="container-na">
            <p>
            Afin d'accèder aux différents pronostics, veuillez vous <span class="open-modal-connexion">connecter</span>.<br>
            Si vous n'êtes pas encore inscrit, veuillez <span class="open-modal-register">cliquer ici</span>.
            </p>
        </div>
    </div>
    <?php
